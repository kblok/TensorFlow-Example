...
with tf.variable_scope("lstm"):
    lstm_cell = tf.contrib.rnn.BasicLSTMCell(hidden_layer_size,
                                             forget_bias=1.0)
    lstm_cell2 = tf.contrib.rnn.BasicLSTMCell(hidden_layer_size,
                                             forget_bias=1.0)
    cell = tf.contrib.rnn.MultiRNNCell(cells=[lstm_cell, lstm_cell2],
                                       state_is_tuple=True)
...
final_output = tf.matmul(states[1][1], weights["linear_layer"]) + biases["linear_layer"]
